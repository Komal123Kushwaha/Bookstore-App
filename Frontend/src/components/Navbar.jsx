...
function Navbar() {
  const [authUser, setAuthUser] = useAuth(); // Context for authUser state
  ...
  // Theme effect to toggle between light and dark
  useEffect(() => {
    if (theme === "dark") {
            ...
            >
              {theme === "light" ? (
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12 4.5V2a1 1 0 1 1 2 0v2.5a1 1 0 1 1-2 0ZM12 22a1 1 0 0 1-2 0v-2.5a1 1 0 0 1 2 0V22Zm-7.8-8.5H2a1 1 0 0 1 0-2h2.5a1 1 0 0 1 0 2ZM22 12a1 1 0 0 1-2 0h-2.5a1 1 0 0 1 0-2H22a1 1 0 0 1 0 2Z" />
                </svg>
              ) : (
                <svg
